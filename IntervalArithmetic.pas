...
function izero : Interval;
function ione : Interval;
...
function IntervalToString(value: Interval): string;
...
//    if DecimalSeparator=','   {for older versions of Delphi Pascal }
  ...
  begin
    iends_to_strings(value, left, right);
    result := left + ' ' + right + ' (' + FloatToStr(int_width(value)) + ')';
  end;
end.
